...
<h1 align="center">AI 思维导图插件 (BuildingAI Mind Map)</h1>
...
<p align="center">
  <a href="https://www.buildingai.cc/plugin" target="_blank"><strong>立即前往应用市场体验</strong></a>
</p>

<p align="center">
  <strong>一款可以用自然语言对话、自动生成可编辑思维导图的智能插件，让灵感和结构一步到位。</strong>
</p>

<p align="center">
  <em>支持多种布局结构、AI 对话生成、可视化编辑、记录管理与后台精细化配置</em>
</p>
...
**BuildingAI Mind Map** 是一款集成在 BuildingAI 平台中的 AI 思维导图工具。  
...
本项目基于 BuildingAI 许可证发布，仅可在 BuildingAI 生态内依照相关协议进行使用与二次开发。
...
- 作者: BuildingAI Teams-dserha

<p align="center">
  <strong>在线思维导图，拥抱无限灵感。</strong>
</p>
