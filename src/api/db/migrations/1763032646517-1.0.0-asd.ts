/**
 * Extension Migration: asd
 * Extension: buildingai-mind-map
 * Version: 1.0.0
 * Generated: 2025-11-13T11:17:28.535Z
 *
...
export class Migration1763032646517 implements MigrationInterface {
    name = "Migration1763032646517";
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "buildingai_mind_map"."mind_map_ai_chat_message" DROP CONSTRAINT IF EXISTS "FK_9b9bc88c1cf6ab741f8bdb3c4be"`,
        );
        await queryRunner.query(
            `ALTER TABLE "buildingai_mind_map"."mind_map_ai_chat_message" DROP CONSTRAINT IF EXISTS "FK_1bede1bec65464b42a9e32bb2ee"`,
        );
        await queryRunner.query(
            `ALTER TABLE "buildingai_mind_map"."mind_map_ai_chat_record" DROP CONSTRAINT IF EXISTS "FK_e429915b27e33e280b24af8716b"`,
        );
        await queryRunner.query(
            `ALTER TABLE "buildingai_mind_map"."mind_map_ai_chat_record" DROP CONSTRAINT IF EXISTS "FK_a3cb295b900910711de711135c1"`,
        );
        await queryRunner.query(
            `COMMENT ON TABLE "buildingai_mind_map"."mind_map_ai_chat_message" IS NULL`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_6fed34ac3488555e4caf072122"`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_ab8f0c1269f2b68a7a45451514"`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_0370bf8484b89453d5b1cfef5f"`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_eb83d20cb7af92ed8e5af1bf24"`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_9b9bc88c1cf6ab741f8bdb3c4b"`,
        );
        await queryRunner.query(
            `DROP TABLE IF EXISTS "buildingai_mind_map"."mind_map_ai_chat_message"`,
        );
        await queryRunner.query(
            `COMMENT ON TABLE "buildingai_mind_map"."mind_map_ai_chat_record" IS NULL`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_42709b755153d5a0257f3edb01"`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_6d03b8d42f16687e029ec3732f"`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_6e1304422af2a6e9c2c3ceae82"`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_6586304d867c98960d49a839a8"`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_e429915b27e33e280b24af8716"`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "buildingai_mind_map"."IDX_a3cb295b900910711de711135c"`,
        );
        await queryRunner.query(
            `DROP TABLE IF EXISTS "buildingai_mind_map"."mind_map_ai_chat_record"`,
        );
        await queryRunner.query(`COMMENT ON TABLE "buildingai_mind_map"."mind_map_config" IS NULL`);
        await queryRunner.query(`DROP TABLE IF EXISTS "buildingai_mind_map"."mind_map_config"`);
        await queryRunner.query(
            `COMMENT ON TABLE "buildingai_mind_map"."mind_map_example" IS NULL`,
        );
        await queryRunner.query(`DROP TABLE IF EXISTS "buildingai_mind_map"."mind_map_example"`);
        await queryRunner.query(`COMMENT ON TABLE "buildingai_mind_map"."mind_map_home" IS NULL`);
        await queryRunner.query(`DROP TABLE IF EXISTS "buildingai_mind_map"."mind_map_home"`);
        await queryRunner.query(`COMMENT ON TABLE "buildingai_mind_map"."mind_map_record" IS NULL`);
        await queryRunner.query(`DROP TABLE IF EXISTS "buildingai_mind_map"."mind_map_record"`);
    }
}
